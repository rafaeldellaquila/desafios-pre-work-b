...
const getFormElement: GetFormElementProps = (target) => (elementName) => {
...
function createImage(data: CreateImageProps) {
...
function createTableRow(data: TableDataProps) {
  const elements = [
